...
func TestHeadersForMatchesHistoricalSeedV1Wire(t *testing.T) {
	...
	historical := Context{
		...
		OrgID: 1, Version: Version1, Timeline: Timeline{EntryResolvedAt: &at},
	}
	...
	if got.BatchID != historical.BatchID || got.Timeline.EntryResolvedAt == nil || !got.Timeline.EntryResolvedAt.Equal(at) {
