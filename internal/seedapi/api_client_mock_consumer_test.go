...
func TestEnsureIAMMockConsumerSendsSharedSecretAndDecodesResponse(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/api/v3/internal/authn/mock-consumers/ensure" {
	...
	resp, err := client.EnsureIAMMockConsumer(context.Background(), "/api/v3/internal/authn/mock-consumers/ensure", EnsureIAMMockConsumerRequest{
		Name:     "Guardian",
		Phone:    "+8619904200001",
